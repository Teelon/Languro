...
export class ReadingGenerator {
  ...
  async generateReadingForUser(userId: string, languageId: number) {
    ...
    // NOTE: Audio generation is handled by Airflow pipeline, not here.
    // The reading content is created first, then audio is generated asynchronously.
      ...
      data: {
        ...
        readingLesson: {
          create: {
            ...
            content,
            difficulty: level,
            audioKey: null, // Will be populated by Airflow TTS pipeline
            alignment: undefined, // Will be generated by Airflow TTS pipeline
          }
        },
