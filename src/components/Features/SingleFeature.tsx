  ...
  return (
    <div className="w-full px-4 md:w-1/2 lg:w-1/4">
      <div className="wow fadeInUp group mb-12" data-wow-delay=".15s">
        ...
        <p className="mb-8 text-slate-600 dark:text-slate-400 lg:mb-11">
          {paragraph}
        </p>
        <Link
          href={btnLink}
          className="text-base font-medium text-slate-900 hover:text-primary dark:text-white dark:hover:text-primary"
        >
          {btn}
        </Link>
      </div>
