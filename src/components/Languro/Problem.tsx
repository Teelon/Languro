const Problem = () => {
  return (
    <section id="problem" className="bg-slate-50 pb-16 pt-16 dark:bg-slate-900 md:pb-20 md:pt-20 lg:pb-28 lg:pt-28">
      <div className="container">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-14 md:grid-cols-3">
          <div className="w-full">
            <div className="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-md bg-red-100 text-red-600 dark:bg-opacity-10 dark:text-red-500">
            ...
            <ul className="mb-8 space-y-4 text-base text-slate-600 dark:text-slate-400">
          ...
          <div className="w-full">
            <div className="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-md bg-yellow-100 text-yellow-600 dark:bg-opacity-10 dark:text-yellow-500">
          ...
          <div className="w-full">
            <div className="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-md bg-orange-100 text-orange-600 dark:bg-opacity-10 dark:text-orange-500">
